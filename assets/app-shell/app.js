...
const MODULE_ICON_URLS = {
  shopping: './assets/app-shell/icons/field-lab/shopping.png?v=0.1.76',
  scheduler: './assets/app-shell/icons/field-lab/scheduler.png?v=0.1.76',
  recipes: './assets/app-shell/icons/field-lab/recipes.png?v=0.1.76',
  foraging: './assets/app-shell/icons/field-lab/foraging.png?v=0.1.76',
  camping: './assets/app-shell/icons/field-lab/camping.png?v=0.1.76',
  fishing: './assets/app-shell/icons/field-lab/fishing.png?v=0.1.76',
  tv: './assets/app-shell/icons/field-lab/tv-tracker.png?v=0.1.76',
  ski: './assets/app-shell/icons/field-lab/ski.png?v=0.1.76',
  ...
  'cg-quilts': './assets/app-shell/icons/field-lab/cg-quilts.png?v=0.1.76',
  timer: './assets/app-shell/icons/field-lab/timer.png?v=0.1.76',
};
